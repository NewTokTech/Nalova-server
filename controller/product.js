...
router.post(
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      const productSize = req.body.sizeData
...
router.post(
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      const productsSizeDatas = await Product.findOne({ _id: req.body.productId })
      console.log(productsSizeDatas, "productsSizeDatas");
      // products.sto
      res.status(201).json({
        success: true,
      });
